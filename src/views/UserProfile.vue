      ...
      <section class="flex-1 bg-white rounded-xl shadow p-6">
        ...
        <form v-else @submit.prevent="onSave" class="space-y-6 mt-6">
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <p class="text-sm text-yellow-700 mt-1">請修改下方資訊，完成後點擊儲存。</p>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full sm:w-4/5">
            <div>
              ...
              <InputText v-model="editProfile.username" class="w-full" placeholder="請輸入用戶名" />
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">手機號碼</label>
              <InputText v-model="editProfile.phone" class="w-full" :class="{ 'p-invalid': phoneError }"
            ...
            <div>
              ...
              <InputText v-model="editProfile.email" class="w-full" :class="{ 'p-invalid': emailError }"
                placeholder="請輸入電子郵件" />
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">地址</label>
              <InputText v-model="editProfile.address" class="w-full" placeholder="請輸入地址（選填）" />
            </div>
          </div>
