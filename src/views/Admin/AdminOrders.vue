...
<template>
  ...
  <div class="mr-8">
    <CommonTable :tabs="orderTabs" :columns="orderColumns" :value="orderValue" @tab-change="handleTabChange" scrollable
      selectable scroll-height="500px">
      <template #body-orderNumber="{ data }">
        <a class="w-full underline text-primary cursor-pointer" @click="
          router.push({
