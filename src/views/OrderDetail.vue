...
<template>
  <div class="space-y-6 bg-white text-black min-h-screen">
    ...
    <div v-else>
      <div
        class="bg-gray-100 p-6 rounded shadow max-w-6xl mx-auto text-center mb-6"
      >
      ...
      <div class="bg-white rounded shadow p-4 max-w-6xl mx-auto space-y-2 mb-4">
      ...
      <!-- 購買商品 -->
      <div class="bg-white rounded shadow p-4 max-w-6xl mx-auto space-y-4 mb-4">
